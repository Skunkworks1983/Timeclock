...
public class Sessions extends TableImpl<SessionsRecord>
{
     ...
     */
    public final TableField<SessionsRecord, Float> SCHEDULEDHOURS = createField(DSL.name("scheduledHours"),
                                                                                SQLDataType.REAL, this, "");
    
    /**
     * The column <code>sessions.startedBy</code>.
     */
    public final TableField<SessionsRecord, String> STARTEDBY = createField(DSL.name("startedBy"),
                                                                            SQLDataType.VARCHAR(36), this, "");
    
    /**
     * The column <code>sessions.endedBy</code>.
     */
    public final TableField<SessionsRecord, String> ENDEDBY = createField(DSL.name("endedBy"), SQLDataType.VARCHAR(36),
                                                                          this, "");
