...
public class MembersRecord extends UpdatableRecordImpl<MembersRecord> implements Record7<String, String, String, String, Float, Integer, Long> {
    ...
    @Override
    public Row7<String, String, String, String, Float, Integer, Long> valuesRow() {
    ...
    @Override
    public MembersRecord values(String value1, String value2, String value3, String value4, Float value5, Integer value6, Long value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public MembersRecord(String id, String role, String firstname, String lastname, Float hours, Integer issignedin, Long lastsignedin) {
        super(Members.MEMBERS);
